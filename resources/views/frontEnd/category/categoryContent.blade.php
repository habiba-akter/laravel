		...
		<div class="grids_of_4">
		 @foreach($productsByCategoryId as $productByCategoryId)
		  <div class="grid1_of_4">
				<div class="content_box"><a href="{{url('product-details/'.$productByCategoryId->id.'/'.$productByCategoryId->product_name)}}">
				    ...
				    <h4><a href="details.html"> {{$productByCategoryId->product_name}}</a></h4>
				     <p>{{$productByCategoryId->product_short_description}}</p>
